...
!(function(t, e) {
  ...
  function ya(t, e) {
    ...
    return (
      r &&
        ...
        t._ts &&
        ((t._start = aa(
          t._dp._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts),
        )),
        xa(t),
        r._dirty || ra(r, t)),
      t
  ...
  function za(t, e) {
    ...
    if (
      ((e._time || (e._initted && !e._dur)) &&
        ((r = wa(t.rawTime(), e)), (!e._dur || yt(0, e.totalDuration(), r) - e._tTime > U) && e.render(r, !0)),
  ...
  function Ca(t, e, r, i) {
    return (
      Nt(t, e),
      t._initted
        ? !r && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && d !== At.frame
  ...
  function Oa(t, e) {
    return (
      t && r(t) && 'length' in t && ((!e && !t.length) || (t.length - 1 in t && r(t[0]))) && !t.nodeType && t !== i
    );
  }
  function Ra(t) {
  ...
  function Ua(u, t) {
    ...
    return (
      !e &&
        r(u) &&
        ((h = e = u.radius || B), u.values ? ((u = bt(u.values)), (l = !p(u[0])) && (h *= h)) : (u = Ta(u.increment))),
      Ja(
        t,
        e
          ? o(u)
            ...
            : function(t) {
                for (
                  var e, r, i = parseFloat(l ? t.x : t), n = parseFloat(l ? t.y : 0), a = B, s = 0, o = u.length;
                  o--;
    ...
    for (var r, i = t._first; i; )
      i instanceof Bt
        ...
        : !i.vars.yoyoEase ||
          (i._yoyo && i._repeat) ||
          i._yoyo === e ||
          (i.timeline ? Bb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
        (i = i._next);
  }
  function Db(t, e, r, i) {
    void 0 === r &&
  ...
  function qk(t) {
    ...
    if (
      (k < a && (A += a - C),
      (0 < (e = (i = (P += a) - A) - S) || s) &&
        ((n = ++T.frame), (b = i - 1e3 * T.time), (T.time = i /= 1e3), (S += e + (D <= e ? 4 : D - e)), (r = 1)),
      s || (g = v(qk)),
      r)
    )
  ...
  var Et,
    ...
    Lt =
      ...
      (Et.totalDuration = function totalDuration(t) {
        return arguments.length
          ? ((this._dirty = 0), Fa(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
  ...
  var Bt = (function(i) {
    ...
    return (
      ...
      (t.staggerFrom = function staggerFrom(t, e, r, i, n, a, o) {
        return (
          (r.runBackwards = 1), (ma(r).immediateRender = s(r.immediateRender)), this.staggerTo(t, e, r, i, n, a, o)
        );
      }),
      ...
      (t.getChildren = function getChildren(t, e, r, i) {
        ...
        for (var n = [], a = this._first; a; )
          a._start >= i &&
            (a instanceof Xt ? e && n.push(a) : (r && n.push(a), t && n.push.apply(n, a.getChildren(!0, e, r)))),
            (a = a._next);
        return n;
      }),
      ...
      (t.totalTime = function totalTime(t, e) {
        return arguments.length
          ? ((this._forcing = 1),
            !this._dp &&
              this._ts &&
              (this._start = aa(At.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
    ...
    Yt = function _addPropTween(t, e, r, i, a, s, u, h, l) {
      ...
      if (
        (n(i) &&
          ...
          '=' === i.charAt(1) &&
            (i = parseFloat(p) + parseFloat(i.substr(2)) * ('-' === i.charAt(0) ? -1 : 1) + (La(p) || 0))),
        p !== i)
      )
        return isNaN(p * i)
          ? (d || e in t || L(e, i),
          ...
          : ((f = new ie(this._pt, t, e, +p || 0, i - (p || 0), 'boolean' == typeof d ? $t : Wt, 0, _)),
            l && (f.fp = l),
      ...
      if (
        ...
        if (((_ = (l = D[0] ? Z(D[0]).harness : 0) && m[l.prop]), (r = la(m, ut)), P && P.render(-1, !0).kill(), v)) {
          ...
          if (P) C || (t._startAt = 0);
            ...
            (e && (y = !1),
            (n = ha(
              { overwrite: !1, data: 'isFromStart', lazy: y && s(T), immediateRender: y, stagger: 0, parent: S },
              r,
            )),
            _ && (n[l.prop] = _),
          ...
          if (
            ...
            for (n in r)
              ft[n] && (f = Nb(n, r, t, p, o, z))
                ? f.priority && (u = 1)
                : (d[n] = a = Yt.call(t, o, n, 'get', r[n], p, z, 0, m.stringFilter));
    ...
    Xt = (function(S) {
      function Tween(t, e, i, n) {
        ...
        if (
          ((a._targets = D.length
            ? Y(D)
            : M('GSAP target ' + t + ' not found. https://greensock.com', !j.nullTargetWarn) || []),
          (a._ptLookup = []),
          (a._overwrite = w),
          x || b || u(v) || u(y))
        ) {
      ...
      return (
          ...
          if (_) {
            if (c !== this._tTime || !t || r || (this._startAt && this._zTime < 0 != t < 0)) {
              ...
              (l && l.render(t < 0 ? t : !i && u ? -U : l._dur * h, e, r)) || (this._startAt && (this._zTime = t)),
                this._onUpdate &&
                  !e &&
                  (t < 0 && this._startAt && this._startAt.render(t, !0, r), xt(this, 'onUpdate')),
            ...
            !(function _renderZeroDurationTween(t, e, r, i) {
              ...
              if (
                ...
                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                  ...
                  (e >= t._tDur || e < 0) &&
                    t.ratio === o &&
                    (o && qa(t, 1), r || (xt(t, o ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()));
        ...
        (t.kill = function kill(t, e) {
          ...
          if (this.timeline) {
            ...
            return (
              this.timeline.killTweensOf(t, e, qt && !0 !== qt.vars.overwrite)._first || fb(this),
              this.parent &&
  ...
  function id(t, e) {
    var r = oe.createElementNS
      ? oe.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : oe.createElement(t);
  ...
  function pd(e) {
    ...
    return (
      ...
      !r || r.width || r.x || r.y
        ? r
        : { x: +od(e, ['x', 'cx', 'x1']) || 0, y: +od(e, ['y', 'cy', 'y1']) || 0, width: 0, height: 0 }
    );
  }
  function qd(t) {
    ...
    return (
      ...
      ze[e] && 'transform' !== e
        ...
        : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) ||
          (n = (Ge[e] && Ge[e](t, e, r)) || jd(t, e) || $(t, e) || ('opacity' === e ? 1 : 0)),
  ...
  function wd(t, e, r, i) {
    ...
    if (
      ...
      (v.e = i),
      (r += ''),
      'auto' === (i += '') && ((t.style[e] = i), (i = jd(t, e) || i), (t.style[e] = r)),
      qb((s = [r, i])),
      (i = s[1]),
      (u = (r = s[0]).match(it) || []),
      (i.match(it) || []).length)
  ...
  function Gd(t, e, r, i, n, a) {
    ...
    r
      ...
      i || (!1 !== i && h.smooth)
        ? ((y = w - f), (T = x - d), (h.xOffset = p + (y * c + T * g) - y), (h.yOffset = _ + (y * m + T * v) - T))
  ...
  var se,
    ...
    er = function _renderCSSTransforms(t, e) {
      ...
      c !== Ke && (y += 'perspective(' + c + tr),
        (i || n) && (y += 'translate(' + i + '%, ' + n + '%) '),
        (!T && a === Ke && s === Ke && o === Ke) ||
          (y += o !== Ke || T ? 'translate3d(' + a + ', ' + s + ', ' + o + ') ' : 'translate(' + a + ', ' + s + tr),
        u !== He && (y += 'rotate(' + u + tr),
        h !== He && (y += 'rotateY(' + h + tr),
        l !== He && (y += 'rotateX(' + l + tr),
        ...
        d || p
          ? ((d *= Re),
            ...
            p &&
              ...
              (n *= s = Math.sqrt(1 + s * s)),
              (a *= s),
              _ && ((s = Math.tan(_)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
            (r = aa(r)),
            (i = aa(i)),
            (n = aa(n)),
            (a = aa(a)))
          ...
          if ('autoRound' !== f && ((s = e[f]), !ft[f] || !Nb(f, e, r, i, t, n)))
            if (
              ...
              if (
                ...
                f in qe &&
                  ('autoAlpha' === f &&
                    (1 === u && 'hidden' === vd(t, 'visibility') && o && (u = 0),
                ...
                if (
                  ...
                  if ('transformOrigin' === f) {
                    (s = yd(s)),
                      g.svg
                        ? Gd(t, s, 0, v, 0, this)
                        : ((p = parseFloat(s.split(' ')[2]) || 0) !== g.zOrigin && sd(this, g, 'zOrigin', g.zOrigin, p),
              ...
              if (c || ((o || 0 === o) && (u || 0 === u) && !Be.test(s) && f in b))
                (o = o || 0),
                  (d = (a + '').substr((u + '').length)) !== (p = La(s) || (f in j.units ? j.units[f] : d)) &&
                    (u = ud(t, f, a, p)),
                  (this._pt = new ie(
                    this._pt,
                    c ? g : b,
