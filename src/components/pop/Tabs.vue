      ...
      tabList: [
        {
          ...
          list: [
            ...
            { label: 'ContainerSlot', param: 'showContainerBerth', value: storage.get('scada_showContainerBerth'), type: 'switch' },
            { label: 'InvalidSpace', param: 'showInvalidSpace', value: storage.get('scada_showInvalidSpace'), type: 'switch' },
            { label: 'waitingSpace', param: 'showWaitingSpace', value: storage.get('scada_showWaitingSpace'), type: 'switch' },
        ...
        },
        {
          ...
          tab: 'Robot',
          list: [
            { label: 'Robot', param: 'showRobots', value: storage.get('scada_showRobots'), type: 'switch' },
            { label: 'OfflineRobot', param: 'showOfflineRobots', value: storage.get('scada_showOfflineRobots') || false, type: 'switch' },
            { label: 'robotPath', value: true, type: 'switch' },
            { label: 'robotId', param: 'showRobotsId', value: storage.get('scada_showRobotsId') || false, type: 'switch' },
